...
#define	TIMER1_BASE	0x80810000 // 16-bit timer
#define	TIMER2_BASE	0x80810020 // 16-bit timer
#define	TIMER3_BASE 0x80810080 // Load value (value it gets reset to)

// 32-bit timer
#define	TIMER3_LOAD 0x80810080 // Load value (value it gets reset to)
#define	TIMER3_READ	0x80810084 // Read value (value of the timer)
#define	TIMER3_CONTROL	0x80810088 // Control value (timer mode)
...
#define UART_INTR_OFFSET	0x1c
  #define MIS_MASK 0x1 // CTS or modem interrupt status
